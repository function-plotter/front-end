...
describe('GraphicComponent', () => {
  ...
  it('should call zoom in function when pressed', fakeAsync(() => {
    ...
    let button = fixture.debugElement.nativeElement.querySelector('button#zoomIn');
    button.click();
    tick();
  ...
  it('should call zoom out function when pressed', fakeAsync(() => {
    ...
    let button = fixture.debugElement.nativeElement.querySelector('button#zoomOut');
    button.click();
    tick();
  ...
  it('should call download png function when pressed', fakeAsync(() => {
    ...
    let button = fixture.debugElement.nativeElement.querySelector('button#downloadPNG');
    button.click();
    tick();
  ...
  it('should call download csv function when pressed', fakeAsync(() => {
    ...
    let button = fixture.debugElement.nativeElement.querySelector('button#downloadCSV');
    button.click();
    tick();
  ...
  it('should draw integral when  function type is integral', () => {
    ...
    const solution = [{x:1, y:3}, {x:2, y:5}];
    const ctx = component.canvas.nativeElement.getContext('2d');
